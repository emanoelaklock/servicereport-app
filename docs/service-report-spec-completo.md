...
- **Referência oficial de pré-lançamento:** snapshot de **julho/2026 RECARIMBADO 14/07 17:30** (0104, sem a janela de instabilidade) persistido em `desempenho_snapshots` (visível só à gestão via RLS; os RPCs do placar não leem snapshots — o corte do go-live segue intacto). Retrato vigente: Alessandro 87 · Marcelo 83 · Max 82 · Maicon 68 · Charles 68 · Arian 62 · Francisco 58 · Pablo 47. *(O carimbo anterior de 13:56, COM a janela — Alessandro 100 · Max 77 · Charles 75 · Maicon 68 · Arian 66 · Marcelo 65 · Pablo 59 · Francisco 58 — fica registrado aqui como parte da primeira calibragem, substituído porque a base de decisão deve refletir a régua vigente.)*
