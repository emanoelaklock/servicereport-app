...
- Fases seguintes: F2 card do técnico ✅ (mergeada; rodada 2 de exibição no PR #102), F3 ranking admin com drill-down + as três lentes de devolução (PR #102), F4 go-live, F5 proteção por campo + métrica v2.1 (carimbo local).
