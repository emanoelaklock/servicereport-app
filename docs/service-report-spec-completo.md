...
- Fases seguintes: F2 card do técnico (só o próprio placar; textos coletivos "da tua equipe"; selo de carência; rótulo "Preenchimento online" + legenda-contrato), F3 ranking admin com drill-down + as três lentes de devolução, F4 go-live, F5 proteção por campo + métrica v2.1 (carimbo local).
