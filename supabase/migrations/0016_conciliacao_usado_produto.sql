-- A Utilizada (lado das RATs) passa a carregar produto_id e código, para que ao lançar Levada
-- numa linha "fora da proposta" ela consolide com o que o técnico usou (match por produto).
