...
<style>${PDF_CSS}</style></head><body>
  ...
  const PDF_CSS = `
    *{box-sizing:border-box}
    body{font-family:Inter,Arial,sans-serif;color:#1B2A4A;margin:38px 44px;font-size:12.5px}
    ...
    @media print{ body{margin:22mm 20mm} a{color:inherit;text-decoration:none} }`
