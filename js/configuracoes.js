...
(function () {
  ...
  async function init() {
    ...
    // Gestão de usuários é centralizada no Portal (portal-tross). Aqui não se cria/edita usuário.
    mostrarSecao('formularios')
  }
  ...
  function renderStatus() {
    ...
    tb.innerHTML = statuses.map(s => `
      <tr>
        ...
        <td>${s.ativo ? '<span class="badge b-done"><i></i>Ativo</span>' : '<span class="badge b-off"><i></i>Inativo</span>'}</td>
  ...
  function renderFormularios() {
    ...
    tb.innerHTML = formularios.map(f => `
      <tr>
        ...
        <td>${f.ativo ? '<span class="badge b-done"><i></i>Ativo</span>' : '<span class="badge b-off"><i></i>Inativo</span>'}</td>
  ...
  function renderTipos() {
    ...
    tb.innerHTML = tipos.map(t => `
      <tr>
        ...
        <td>${t.ativo ? '<span class="badge b-done"><i></i>Ativo</span>' : '<span class="badge b-off"><i></i>Inativo</span>'}</td>
  ...
  function renderVeiculos() {
    ...
    tb.innerHTML = veiculos.map(v => `
      <tr>
        <td>${esc(v.modelo || '—')}</td>
        <td>${esc(v.placa || '—')}</td>
        <td>${v.ativo ? '<span class="badge b-done"><i></i>Ativo</span>' : '<span class="badge b-off"><i></i>Inativo</span>'}</td>
  ...
  function renderCadastro(kind, rows, tipo) {
    ...
    tb.innerHTML = rows.map(r => {
      ...
      let status
      if (r.oculto) status = '<span class="badge b-off"><i></i>Oculto</span>'
      else if (!r.ativo) status = '<span class="badge b-off"><i></i>Inativo</span>'
